...
/**
 * Up to 500 top and new stories, include new/top/best/ask/show/job stories ({@link APIConfig})
 * @category live data
 */
export const GetStoriesConfig: APIConfig = {
  ...
  description:
    "Up to 500 top and new stories, include new/top/best/ask/show/job stories",
  category: "live data",
  paramsInUrl: '{}'
};
/**
